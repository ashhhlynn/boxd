    ...
    return (
        ...
        <Item style={{marginLeft:"3%", marginRight:"-58%"}}>
            ...
            <Item style={{ marginLeft:"27%", marginBottom:"5.25%", marginTop:"-9%", textAlign:"left"}}>
                <h3>
                    {movie.title}
                    <Label as="p" style={{background:"none", fontWeight:"normal", marginTop:"-2%",color:"white"}}>{movie.year}</Label>
                    <br/>
                    <Rating className="stars" rating={movie.rating} disabled maxRating={5} />
                </h3>
            </Item>
